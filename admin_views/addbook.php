...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    <a href="<?php echo base_url('index.php/admin/admin_panel');?>" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="widget.html" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Add book</a>
        ...
        <?php
            ...
            ?>
            <form id="book_form" method="post" action="<?=base_url('index.php/admin/save_book')?>" enctype="multipart/form-data">
                <label class="book_label" for="book_name">Book name</label><br>
                <input class="book_input" type="text" id="book_name" name="book_name" />
                <label class="book_label" for="author_name">Author name</label><br>
                <input class="book_input" type="text" id="author_name" name="book_author" />
                <label class="book_label" for="count">Count</label><br>
                <input class="book_input" type="text" id="count" name="count" />
                <label class="book_label" for="image">Add image</label><br>
                <input class="book_input" type="file" id="image" name="image" size="33" /><br>
                <input id="book_submit" type="submit" value="Add book" />
            </form>
    </div>
