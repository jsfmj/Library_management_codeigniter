...
<head>
  ...
  margin: 0;
  padding: 0;
  background-image:url("<?php echo base_url('assets/img/library-hero-bg.jpg')?>");
...
<body>
  ...
  <div class="form-box login">
    <h2>Login</h2>
    <form method="post" action="<?php echo base_url('index.php/welcome/data')?>">
      <div class="input-box">
      ...
      <div class="login-register">
        <p>Don't have an account? <a href="#" class="register-link">
          Register
        </a><br><br><a href="<?php echo base_url('index.php/Admin/admin_login')?>" class="register-link">
          Admin login
        </a></p>
      ...
      <?php
        if (isset($error_message)) {
            echo '<div style="color: red; margin-left:65px; margin-bottom:10px; font-size:25px; font-weight:bold;">' . $error_message . '</div>';
        }
      ?>
    </form>
  </div>
