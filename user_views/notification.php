...
.notification-row {
    background-color: #f0f0f0; /* Background color for alternate rows */
...
/* Style for the notification message cell */
.notification-message {
	
    padding: 15px; /* Increased padding for better spacing */
    font-size: 21px; /* Bigger font size */
		font-weight: bold;
    border-bottom: 1px solid #ddd; /* Border between notification rows */
}
...
.clear-button {
    display: block;
    margin: 20px auto; /* Center the button horizontally with auto margin */
    padding: 10px 15px;
    background-color: #374b56; /* Button background color */
...
<body>
    ...
    <tbody>
        <?php foreach ($notifications as $notification) : ?>
					<button class="clear-button" data-user-name="<?= $notification['username']; ?>" data-user-message="<?= $notification['message']; ?>">Clear notifications</button>
 ...
 <script src="<?php echo base_url('assets/js/jquery-1.11.3.min.js');?>"></script>
	...
	<script>
        $(document).ready(function () {
            ...
            var isConfirmed = confirm("Are you sure you want to delete all notifications?");
            // alert(isConfirmed);
            // exit;
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url() ?>index.php/Welcome/clearnotification",
                data: {
                    username: username,
