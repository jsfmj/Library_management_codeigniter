			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<div class="site-logo">
							<a href="index.html">
							<img src="assets/img/book-logo2.png" alt="">
							</a>
						</div>
						<!-- logo -->
							...
							<ul>
								...
								<li>
									<div class="header-icons">
										<a class="shopping-cart" href="<?php echo base_url('index.php/welcome/displayCart')?>"><i class="fas fa-shopping-cart"></i></a>
									</div>
								</li>
							</ul>
						</nav>
		...
		<div class="container">
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
                            ...
                            <li data-filter=".Fiction">Fiction</li>
			...
			<?php 
             foreach ($books as $book) : ?>
				<div class="col-lg-4 col-md-6 text-center Fiction">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img style="width:50%; height:50%;" src="<?= $book['image']; ?>" alt=""></a>	
						</div>
						<h3><?= $book['book_name']; ?></h3>
						<p class="product-price"><span><?= $book['book_author']; ?></span></p>
						<a href="#" class="cart-btn" data-book-id="<?= $book['id']; ?>" data-book-name="<?= $book['book_name']; ?>" data-book-author="<?= $book['book_author']; ?>" data-book-image="<?= $book['image']; ?>">
				...
				<!-- <div class="col-lg-4 col-md-6 text-center berry">
					<div class="single-product-item">
						...
						<a href="cart.html" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to list</a>
					</div>
				</div>
...
<script>
    $(document).ready(function () {
        ...
        $(".cart-btn").on("click", function (event) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= base_url('index.php/Welcome/addToCart'); ?>",
                data: {
                    book_id: bookId,
                    book_name: bookName,
